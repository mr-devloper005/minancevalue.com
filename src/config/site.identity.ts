export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'minancevalue',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Minancevalue',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'minancevalue.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://minancevalue.com',
